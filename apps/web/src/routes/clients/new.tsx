              ...
              <form.Field name="name">
                {(field) => (
                  <div className="space-y-1.5">
                    ...
                    <Input id="name" value={field.state.value} onChange={(e) => field.handleChange(e.target.value)} placeholder="Client or company name" required className="h-10 bg-background/50 border-border/60" />
                  </div>
                )}
              </form.Field>
